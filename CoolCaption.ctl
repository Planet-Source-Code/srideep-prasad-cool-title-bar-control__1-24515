VERSION 5.00
Begin VB.UserControl CoolCaption 
   BackColor       =   &H00FFFFC0&
   ...
   Picture         =   "CoolCaption.ctx":0000
   PropertyPages   =   "CoolCaption.ctx":0442
   ScaleHeight     =   540
   ScaleWidth      =   585
   ToolboxBitmap   =   "CoolCaption.ctx":0468
...
Dim Par As Form, CFrm As CapFrm
...
'WARNING! DO NOT REMOVE OR MODIFY THE FOLLOWING COMMENTED LINES!
'MemberInfo=7,0,0,1
Public Property Get ButtonGradStyle() As GStyles
Attribute ButtonGradStyle.VB_Description = "Sets/Returns the Window button gradient style"
    ButtonGradStyle = m_HighlightStyle
End Property

Public Property Let ButtonGradStyle(ByVal New_ButtonGradStyle As GStyles)
...
'WARNING! DO NOT REMOVE OR MODIFY THE FOLLOWING COMMENTED LINES!
'MemberInfo=7,0,0,1
Public Property Get CaptionGradStyle() As GStyles
...
Public Property Let CaptionGradStyle(ByVal New_CaptionGradStyle As GStyles)
